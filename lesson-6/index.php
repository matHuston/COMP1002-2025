...
<nav> 
	<ul>
		...
		<li><a href="red.php" title="Go to the Red Page">Red Page</a></li>
		<li><a href="blue.php" title="Go to the Blue Page">Blue Page</a></li>
		<li><a href="yellow.php" title="Go to the Yellow Page">Yellow Page</a></li>
	</ul>
</nav>
<!-- STEP 4: Inside the NAV element, build a list of hyperlinks to other pages in
...
<!-- STEP 1a: Build an A (anchor) element that surrounds the word 'LEGO®' inside the FIGCAPTION below -->
					<figcaption><a href="">LEGO®</a> mini figure by Vanja (Public Domain)</figcaption>
