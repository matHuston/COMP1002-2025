...
<img src="images/html-logo.svg" alt="HTMLego graphic" height="50" width="50" title="HTMLego">
...
<!-- STEP 1: Insert an IMG element with the src attribute pointing to the image called "mini-figure" in the 'images' directory -->
 				<figure> <!--makes image a block with added caption-->
                	<img src="images/mini-figure.png" alt="Lego Mini-Figure" width="176" height="285"/>
                	<figcaption>Mini figure by Vanja (Public Domain)</figcaption> <!--caption-->
        		</figure>
